...
/** 四边渐变暗角——画面立刻变"电影" */
export function addVignette(scene: Phaser.Scene, strength = 0.3): Phaser.GameObjects.Graphics {
...
/** 夜灯流萤：金色微光缓慢漂移呼吸 */
export function addFireflies(scene: Phaser.Scene, count = 14, area = { x0: 60, x1: 1860, y0: 380, y1: 850 }): void {
